	...
	attack_hand(mob/user as mob)
		...
		switch(screen)
			...
			if(3.2) //Protolathe Material Storage Sub-menu
				...
				dat += "Eject: "
				if(linked_lathe.phoron_amount >= 3750) dat += "<A href='?src=\ref[src];lathe_ejectsheet=phoron;lathe_ejectsheet_amt=1'>(1 Sheet)</A> "
				if(linked_lathe.phoron_amount >= 18750) dat += "<A href='?src=\ref[src];lathe_ejectsheet=phoron;lathe_ejectsheet_amt=5'>(5 Sheets)</A> "
				if(linked_lathe.phoron_amount >= 3750) dat += "<A href='?src=\ref[src];lathe_ejectsheet=phoron;lathe_ejectsheet_amt=50'>(Max Sheets)</A>"
				dat += "<BR>"
				//Uranium
