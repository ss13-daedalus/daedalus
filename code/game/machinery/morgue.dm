...
/obj/structure/m_tray/CanPass(atom/movable/mover, turf/target, height=0, FEA_airgroup=0)
...
/obj/structure/c_tray/CanPass(atom/movable/mover, turf/target, height=0, FEA_airgroup=0)
	if (istype(mover, /obj/item/weapon/dummy))
		return 1
	else
		return ..()
