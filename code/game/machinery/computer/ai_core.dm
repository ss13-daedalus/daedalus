...
/obj/structure/AIcore/attackby(obj/item/P as obj, mob/user as mob)
	switch(state)
		...
		if(3)
			...
			if(istype(P, /obj/item/weapon/ai_module/asimov))
			...
			if(istype(P, /obj/item/weapon/ai_module/nanotrasen))
			...
			if(istype(P, /obj/item/weapon/ai_module/purge))
				laws.clear_inherent_laws()
				usr << "Law module applied."


			if(istype(P, /obj/item/weapon/ai_module/freeform))
				var/obj/item/weapon/ai_module/freeform/M = P
