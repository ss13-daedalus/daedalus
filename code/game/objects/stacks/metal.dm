...
var/global/list/datum/stack_recipe/metal_recipes = list ( \
	...
	new/datum/stack_recipe("tube light frame", /obj/structure/light_fixture_frame), \
	new/datum/stack_recipe("small light frame", /obj/structure/light_fixture_frame/small), \
	new/datum/stack_recipe("table lamp frame", /obj/structure/light_fixture_frame/lamp), \
	null, \
...
var/global/list/datum/stack_recipe/cardboard_recipes = list ( \
	...
	new/datum/stack_recipe("light tubes", /obj/item/weapon/storage/lamp_box/tubes), \
	new/datum/stack_recipe("light bulbs", /obj/item/weapon/storage/lamp_box/bulbs), \
