...
/obj/structure/table/can_pass(atom/movable/mover, turf/target, height=0, air_group=0)
...
/obj/structure/rack/can_pass(atom/movable/mover, turf/target, height=0, air_group=0)
	if(air_group || (height==0)) return 1
