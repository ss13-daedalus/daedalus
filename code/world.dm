...
/world/proc/load_motd()
	join_motd = file2text("config/motd.html")
...
/world/proc/update_status()
	...
	s += "<b>[station_name()]</b>";
	s += " ("
	s += "<a href=\"http://daedalus.nss-icarus.net\">" //Change this to wherever you want the hub to link to.
//	s += "[game_version]"
	s += "Daedalus"  //Replace this with something else. Or ever better, delete it and uncomment the game version.
	s += "</a>"
	s += ")"
