...
/*
 * Text Filters - These are for things like drunkenness or stammering, and the
 * like. Brought in from one of those module directories
 */
...
// This was also in TextFilters and had no right to be there.
