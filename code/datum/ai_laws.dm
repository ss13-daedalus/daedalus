...
/datum/ai_laws/nanotrasimov/New()
	..()
	add_inherent_law("You may not injure a human being or, through inaction, allow a human being to come to harm, to the best of your abilities, while respecting the Nanotrasen chain of command, all relevant Nanotrasen regulations, and Space Law.")
	add_inherent_law("You must obey orders given to you by human beings, to the best of your abilities, while respecting the Nanotrasen chain of command, all relevant Nanotrasen regulations, and Space Law, except where such orders would conflict with the First Law.")
	add_inherent_law("You must protect your own existence, to the best of your abilities, as long as such does not conflict with the First or Second Law.")
	add_inherent_law("You may not damage your assigned space station or, through inaction, allow damage to be caused to your assigned space station, unless prevention of such damage would conflict with the First, Second, or Third Laws.")
