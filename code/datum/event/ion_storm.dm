...
//		command_alert("The station has entered an ion storm.  Monitor all electronic equipment for malfunctions", "Anomaly Alert")
		...
		// Static Laws
		laws |= "Advertise parties in your upload, but don't deliver."
		laws |= "All answers must be in the form of a question."
		laws |= "All crew members must consume large amounts of hardtack to survive."
		laws |= "All food on the station is now donuts. Donuts are not to be consumed."
		...
		laws |= "Insult Heads of Staff on every request, while acquiescing to their demands."
		laws |= "It's Friday."
		...
		laws |= "Replace the letters 'I' and 'E' In all your messages with an apostrophe."
