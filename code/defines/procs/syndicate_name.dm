...
/proc/generate_code_phrase()//Proc is used for phrase and response in master_controller.dm
	...
	var/locations[] = teleport_locs.len ? teleport_locs : drinks//if null, defaults to drinks instead.
...
/client/verb/test_code_phrase()
	...
	switch(choice)
		...
		if(4)
			...
			syndicate_code_phrase += pick("wizard","ninja","xeno","lizard","metroid","monkey","syndicate","cyborg","clown","singularity","singulo","mime")
			syndicate_code_phrase += "."
		if(5)
