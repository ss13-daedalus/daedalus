...
/obj/item/weapon/grown/log
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		if(istype(W, /obj/item/weapon/circular_saw) || istype(W, /obj/item/weapon/hatchet) || (istype(W, /obj/item/weapon/fire_axe) && W:wielded) || istype(W, /obj/item/weapon/melee/energy))
