...
/obj/item/weapon/welding_pack/New()
...
/obj/item/weapon/welding_pack/afterattack(obj/O as obj, mob/user as mob)
...
/obj/item/weapon/welding_pack/examine()
	set src in usr
