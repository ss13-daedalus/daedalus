		...
		for(var/atom/movable/stomachContent in contents)
			if(prob(digestionProbability))
				if(istype(stomachContent,/obj/item/stack)) //converts to phoron, keeping the stack value
					if(!istype(stomachContent,/obj/item/stack/sheet/phoron))
						var/obj/item/stack/oldStack = stomachContent
						new /obj/item/stack/sheet/phoron(src, oldStack.amount)
						del(oldStack)
						continue
				else if(istype(stomachContent,/obj/item)) //converts to phoron, keeping the w_class
					var/obj/item/oldItem = stomachContent
					new /obj/item/stack/sheet/phoron(src, oldItem.w_class)
					del(oldItem)
					continue
				else
					new /obj/item/stack/sheet/phoron(src, flatPhoronValue) //just flat amount
					del(stomachContent)
					continue
